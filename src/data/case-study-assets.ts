...
import dfoSarpang from '../assets/wangdi-dfo-sarpang.jpg';

export const caseStudyAssets: Record<string, Record<string, ImageMetadata>> = {
  'connected-skies': { GH1, GH2, GH3, GH4, GH6, SC3, W1, W2, WB1 },
};

export const caseStudyPreviewAssets: Record<
  string,
  { image: ImageMetadata; alt: string; objectPosition?: string }
> = {
  'divisional-forest-office-management-plan': {
    image: dfoSarpang,
    alt: 'Wangdi in forestry uniform outside the Divisional Forest Office in Sarpang beneath the office sign',
